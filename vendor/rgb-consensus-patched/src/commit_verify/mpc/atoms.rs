...
use crate::commit_verify::{
    CommitEncode, CommitEngine, CommitmentId, MerkleHash, LIB_NAME_COMMIT_VERIFY,
};
...
impl DefaultBasedStrictDumb for ProtocolId {}
...
#[derive(StrictType, StrictEncode, StrictDecode)]
#[strict_type(lib = LIB_NAME_COMMIT_VERIFY, tags = custom)]
pub enum Leaf {
