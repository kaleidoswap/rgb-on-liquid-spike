...
///
/// ```
/// # use rgbcore::commit_verify::CommitmentProtocol;
///
/// // Uninstantiable type
/// pub enum Lnpbp6 {}
///
...
pub(crate) mod test_helpers {
    ...
    use super::*;
    use crate::commit_verify::{ConvolveCommit, ConvolveCommitProof};
...
mod test {
    ...
    use super::*;
    use crate::commit_verify::digest::DigestExt;
        ...
        T: AsRef<[u8]> + Clone,
    {
        ...
        fn restore_original(&self, _: &[u8; 32]) -> DummyVec {
            DummyVec(default!())
        }
